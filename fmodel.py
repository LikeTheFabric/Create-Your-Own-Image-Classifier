...
def save_checkpoint(train_data, model = 0, path = 'checkpoint.pth', structure = 'vgg16', hidden_units = 4096, dropout = 0.3, lr = 0.001, ephochs = 1):
...
def load_checkpoint(path = 'checkpoint.pth'):
    ...
    structure = checkpoint['sturcture']
...
def process_image(image):
    ''' Scales, crops, and normaizes a PIL image for a PyTorch Model, 
