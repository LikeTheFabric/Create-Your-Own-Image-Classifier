...
parser.add_argument('input', ddefualt='./flowers/test/1/image_06752.jpg', nargs='?', action="store", type = str)
parser.add_argument('--dir', action="store",dest="data_dir", defualt="./flowers/")
parser.add_argument('checkpoint', default='.checkpoint.pth', nargs='?', action="store", type = str)
parser.add_argument('--top_k' default=5, dest="top_k", action="store", type=int)
parser.add_argument('--category_names', dest="category_names", action="store", defualt='cat_to_name.json')
parser.add_argument('--gpu', defualt="gpu", action="store", dest="gpu")
